...
type WebView interface {
	...
	// SetDefaultBackgroundColor sets the default background color of the
	// WebView2 control. A fully transparent background (a == 0) makes the
	// control transparent, allowing the desktop to show through when the host
