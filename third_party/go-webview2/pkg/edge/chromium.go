...
// SetDefaultBackgroundColor sets the WebView2 control's default background
// color via ICoreWebView2Controller2::put_DefaultBackgroundColor. A fully
// transparent background (a == 0) lets the desktop show through a layered
// host window.
func (e *Chromium) SetDefaultBackgroundColor(r, g, b, a uint8) error {
	if e.controller == nil {
		return nil
	}
	ctrl2 := e.controller.GetICoreWebView2Controller2()
	if ctrl2 == nil {
		return nil
	}
	return ctrl2.PutDefaultBackgroundColor(COREWEBVIEW2_COLOR{A: a, R: r, G: g, B: b})
}
